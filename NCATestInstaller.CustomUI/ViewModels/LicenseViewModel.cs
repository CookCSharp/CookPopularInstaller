...
namespace NCATestInstaller.CustomUI.ViewModels
{
    public class LicenseViewModel : ViewModelBase
    {
        ...
        {
            //using var fs = new FileStream(@"D:\Users\chance.zheng\Desktop\Company\NCATestInstaller\NCATestInstaller.CustomUI\Assets\ONESLicense", FileMode.Open, FileAccess.Read, FileShare.Read);
