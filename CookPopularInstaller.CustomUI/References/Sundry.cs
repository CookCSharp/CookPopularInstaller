...
using ProcessHelper = CookPopularInstaller.Toolkit.Helpers.ProcessHelper;
//using SharpCompress.Archives;
//using SharpCompress.Archives.Rar;
//using SharpCompress.Readers;

namespace CookPopularInstaller.CustomUI.References
{
    /// <summary>
    /// 杂项类
    /// </summary>
    public class Sundry
    {
        ...
        private async Task InstallDepends()
        {
            ...
            foreach (var depend in package.Depend.DependDialogVariables)
            {
                ...
                await DispatcherHelper.AppInvokeAsync(() => Message = $"正在安装{depend.Name}...");
        ...
        private async Task InstallExtensions()
        {
            ...
            await Task.Run(async () =>
            {
                ...
                await DispatcherHelper.AppInvokeAsync(() => Message = $"正在启动服务...");
        ...
        private async Task UninstallExtensions()
        {
            ...
            await Task.Run(async () =>
            {
                ...
                await DispatcherHelper.AppInvokeAsync(() => Message = $"正在删除服务...");
                package.Extension.WindowsServices.ForEach(service =>
                {
